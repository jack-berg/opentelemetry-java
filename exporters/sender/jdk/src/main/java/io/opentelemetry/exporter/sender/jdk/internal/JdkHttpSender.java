...
public final class JdkHttpSender implements HttpSender {
  ...
  JdkHttpSender(
    ...
    this.failExceptionRetryPredicate =
        Optional.ofNullable(retryPolicy)
            .map(RetryPolicy::getFailExceptionRetryPredicate)
            .orElse(JdkHttpSender::defaultFailExceptionRetryPredicate);
  }
  ...
  private static boolean defaultFailExceptionRetryPredicate(IOException throwable) {
